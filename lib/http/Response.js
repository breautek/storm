...
class Response {
	...
	send(data) {
		if (data instanceof ResponseData) {
			...
			var statusCode = this.getStatusCodeByErrorType(data) || StatusCode.INTERNAL_ERROR;
	...
	getStatusCodeByErrorType(error) {
		if (data instanceof errors.InternalError) {
			return StatusCode.INTERNAL_ERROR;
		}
		else if (data instanceof errors.BadInput) {
