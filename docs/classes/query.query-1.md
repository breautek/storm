[@breautek/storm](../README.md) / [Exports](../modules.md) / [Query](../modules/query.md) / Query
...
Defined in: [src/Query.ts:35](https://github.com/breautek/storm/blob/ec148ff/src/Query.ts#L35)
