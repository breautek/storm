...
Defined in: [src/IRequestResponse.ts:21](https://github.com/breautek/storm/blob/4e204d2/src/IRequestResponse.ts#L21)
...
Defined in: [src/IRequestResponse.ts:22](https://github.com/breautek/storm/blob/4e204d2/src/IRequestResponse.ts#L22)
