...
Defined in: [src/IRequestResponse.ts:21](https://github.com/breautek/storm/blob/51bc6e5/src/IRequestResponse.ts#L21)
...
Defined in: [src/IRequestResponse.ts:22](https://github.com/breautek/storm/blob/51bc6e5/src/IRequestResponse.ts#L22)
