...
Defined in: [src/IRequestResponse.ts:21](https://github.com/breautek/storm/blob/d383af9/src/IRequestResponse.ts#L21)
...
Defined in: [src/IRequestResponse.ts:22](https://github.com/breautek/storm/blob/d383af9/src/IRequestResponse.ts#L22)
