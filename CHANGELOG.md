...
* feat: Transaction API

* deproll

* Require NodeJS 14.x note

* commander 8 -&gt; 10

* sql-formatter 4.x -&gt; 12.x

* feat: Transaction API

* fix: SQL formatting options

* Tests: Transanction API

* fix jest complaints about globals config usage
